...
- Update README with maintenance warning for kwaak ([#607](https://github.com/bosun-ai/kwaak/pull/607))

### ⚙️ Miscellaneous Tasks

- Update Swiftide to 0.31 ([#582](https://github.com/bosun-ai/kwaak/pull/582))
...
- Support using Github as app ([#528](https://github.com/bosun-ai/kwaak/pull/528))
- Allow starting task from main branch ([#531](https://github.com/bosun-ai/kwaak/pull/531))
- Support multiple languages in a repository ([#527](https://github.com/bosun-ai/kwaak/pull/527))
- Faster builds with buildkit ([#537](https://github.com/bosun-ai/kwaak/pull/537))
- [**breaking**] Faster and (way) more efficient indexing and retrieval ([#538](https://github.com/bosun-ai/kwaak/pull/538))
- Remove support for fastembed ([#546](https://github.com/bosun-ai/kwaak/pull/546))

### 🐛 Bug Fixes

- Update latest swiftide with faster executor ([#515](https://github.com/bosun-ai/kwaak/pull/515))
- Typo in query-pipeline.ipynb ([#535](https://github.com/bosun-ai/kwaak/pull/535))
- Clippy
- Add maximum amount of columns to the output of ripgrep ([#564](https://github.com/bosun-ai/kwaak/pull/564))

### 💼 Other

- *(deps)* Bump tui-markdown from 0.3.3 to 0.3.4 in the minor group ([#508](https://github.com/bosun-ai/kwaak/pull/508))
- *(deps)* Bump the minor group across 1 directory with 4 updates ([#513](https://github.com/bosun-ai/kwaak/pull/513))

### 🚜 Refactor

- Allow modifying agents before starting new agents in a session ([#512](https://github.com/bosun-ai/kwaak/pull/512))
...
- Update to swiftide 0.28 ([#536](https://github.com/bosun-ai/kwaak/pull/536))
- Update deps
- Update to Swiftide 0.30 ([#567](https://github.com/bosun-ai/kwaak/pull/567))
