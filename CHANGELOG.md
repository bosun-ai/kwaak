...
- Check for updates on boot with a more compact header ([#380](https://github.com/bosun-ai/kwaak/pull/380))

### 🐛 Bug Fixes

- *(build)* Compile time recursion limit back to default ([#379](https://github.com/bosun-ai/kwaak/pull/379))

### 💼 Other

- Optimize docker build time ([#370](https://github.com/bosun-ai/kwaak/pull/370))
