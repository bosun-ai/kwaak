...
use crate::{duckdb, repository::Repository, runtime_settings::RuntimeSettings};
...
impl<'repository> GarbageCollector<'repository> {
    pub fn from_repository(repository: &'repository Repository) -> Self {
        ...
        Self {
            ...
            duckdb: duckdb::get_duckdb(repository),
            file_extensions,
        }
    }
...
mod tests {
    ...
    async fn setup() -> TestContext {
        ...
        let duckdb = duckdb::build_duckdb(&repository).unwrap();
